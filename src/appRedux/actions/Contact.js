...
export const onAddContact = (contact) => {
  return dispatch => database.ref('/contacts').push(contact);
};


export const onUpdateContact = (id, contact) => {

  return dispatch => database.ref('/contacts').child(id).update(contact);
};

export const onDeleteContact = (id) => {
  return dispatch => database.ref('/contacts').child(id).remove();
};
