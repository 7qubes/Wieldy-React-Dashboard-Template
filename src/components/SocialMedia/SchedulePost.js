...
class SchedulePost extends React.Component {
  ...
  getSocialMediaIcon = (medium) => {
    switch (parseInt(medium)) {
      case 1:
        return (
          <FacebookFilled style={{ fontSize: "32px", color: "#1877f2" }} />
        );
      case 2:
      ...
      case 3:
        return (
          <TwitterOutlined
            style={{ fontSize: "32px", color: "rgba(29,161,242,1.00)" }}
          />
        );
      case 4:
        return (
          <LinkedinOutlined style={{ fontSize: "32px", color: "#0073b1" }} />
        );
    }
  };
  onChange = (e, type) => {
  ...
  onSubmit = () => {
    ...
    this.props.onOk({
      ...
      user_id: 123,
      text:
        this.state.text + " " + (this.state.hashtag ? this.state.hashtag : ""),
  ...
  render() {
    ...
    return (
      <Modal
        ...
        title={
          <h2>
            {this.getSocialMediaIcon(this.state.account["medium"])}
            {<span>&emsp;</span>}
        ...
        footer={[
          <div>
            ...
            <DatePicker
              allowClear={false}
              value={moment(this.state.selectedTime)}
            ...
            <Button
              ...
              style={{ marginLeft: "5px" }}
            >
              {this.state.mode == "edit" ? "Edit Post" : "Schedule Post"}
            </Button>
          </div>,
        ]}
      >
          ...
          <div className="gx-modal-box-form-item">
            <Row>
              ...
              <Col md={18}>
                ...
                <TextArea
                  ...
                  placeholder="Add Hashtags separated by a space"
                  rows={2}
                />
            ...
            <Row style={{ paddingTop: 20, paddingLeft: 20 }}>
              <h5>
                ...
                {moment
                  .tz(moment(this.state.selectedTime), this.state.timezone)
